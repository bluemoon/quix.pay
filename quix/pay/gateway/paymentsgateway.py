...
class PaymentsGateway(AbstractGateway):
    """ 
    Interface to the PaymentsGateway payment gateway.
    ...
    def eft_credit(self, amount, check, customer, merchant_id='139408',
        ...
        fields = {
            ...
            'ecom_payment_check_trn': '011400178'
        }
    ...
    def _prepare_fields(self, fields):
        """ Prepare fields for sending to PaymentsGateway """
    ...
    def __str__(self):
        return "PaymentsGateway POST Integration"
